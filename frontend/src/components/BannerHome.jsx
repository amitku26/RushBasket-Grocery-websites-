...
import { features } from "../assets/Dummy.jsx";
  ...
  const handleSubmit = (e) => {
    ...
    if (trimmedTerm) {
      if (onSearch) {
        ...
        navigate(`/itm?search=${encodeURIComponent(trimmedTerm)}`);
      }
      setSearchTerm("");
    }
  };
          ...
          <div className="text-center md:text-left">
            <div className={bannerStyles.tag}>
              <span className="flex items-center text-sm sm:text-base">
                <FiTruck className="mr-2" /> Free Delivery on Orders Over $50
              </span>
            </div>
            ...
            <p className={bannerStyles.paragraph}>
              Discover the freshest products, top-quality meats, and pantry
