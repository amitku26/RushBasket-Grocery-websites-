...
import { FiFilter, FiPackage, FiTrash } from "react-icons/fi";
import axios from "axios";

const StatsCard = ({ icon: Icon, border, color, label, value }) => (
...
const ListItemsPage = () => {
  ...
  useEffect(() => {
    const loadItems = async () => {
      try {
        const { data } = await axios.get("https://rushbasket-grocery-websites-backend.onrender.com/api/items");
        ...
        alert("Could not load products. Check console for errors.");
      }
    };
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://rushbasket-grocery-websites-backend.onrender.com/api/items/${id}`);
            ...
            <div className={styles.emptyStateContainer}>
              ...
              <p className={styles.emptyStateText}>
                {selectedCategory === "All"
                  ...
                  : `No product found in ${selectedCategory} category.`}
              </p>
            </div>
          ) : (
